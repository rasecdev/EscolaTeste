        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Professor>()
                .HasData(new List<Professor>(){
                    new Professor(1, "João"),
                    new Professor(2, "Maria"),
                    new Professor(3, "José"),
                    new Professor(4, "Carlos"),
            ...
            builder.Entity<Disciplina>()
                .HasData(new List<Disciplina>{
                    ...
                    new Disciplina(2, "Geografia", 2),
                    new Disciplina(3, "Português", 3),
                    new Disciplina(4, "História", 4),
                    new Disciplina(5, "Gramática", 5)
                });

            builder.Entity<Aluno>()
                .HasData(new List<Aluno>(){
                    new Aluno(1, "João", "José", "33225555"),
                    new Aluno(2, "Paula", "Maria", "3354288"),
                    new Aluno(3, "Maria", "Antonia", "55668899"),
                    new Aluno(4, "Luiza", "Antonia", "6565659"),
                    new Aluno(5, "Antonia", "Machado", "565685415"),
                    new Aluno(6, "Carlos", "Alvares", "456454545"),
